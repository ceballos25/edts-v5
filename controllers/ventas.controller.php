...
class VentasController {
    ...
    public static function obtenerVentas() {
        ...
        $select = 'id_sale,code_sale,total_sale,payment_method_sale,status_sale,date_created_sale,quantity_sale,name_customer,lastname_customer,phone_customer,email_customer,city_customer,title_raffle';
...
public static function crearVenta($data)
{
    ...
    $idVenta = $resVenta->results->lastId;
    ...
    public static function obtenerFiltros() {
        ...
        return compact('search', 'idRaffle', 'metodoPago', 'dateFrom', 'dateTo');
    }
    ...
    public static function determinarColumnasBusqueda($search) {
        ...
        if (stripos($search, 'CR-') === 0 || stripos($search, 'PB-') === 0) {
            return ['code_sale'];
        }
        ...
        if (is_numeric($search)) {
            return strlen($search) <= 5 ? ['id_sale'] : ['phone_customer'];
        }
        
        return ['name_customer', 'lastname_customer'];
    }
    ...
    public static function generarRecibo($venta, $tickets) {
        ...
        foreach ($tickets as $t) {
            $htmlTickets .= '<span style="display:inline-block; text-decoration:none !important; margin:3px; padding:5px 10px; background:#1a1a1a; color:#d4af37; border:1px solid #d4af37; border-radius:5px; font-weight:bold;">' 
                         . $t->number_ticket . '</span> ';
        }
